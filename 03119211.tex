...
\lstset{
    basicstyle=\ttfamily\small, % Set the basic style of the listing
    breaklines=true, % Enable line breaking
    postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space}, % Indicator for line break
    frame=single, % Frame around the code
    caption={Your File Caption}, % Caption for the listing
...
\lstinputlisting{output/output6_finalplan.csv} % Path to your file
...
\lstinputlisting{output/output7_finalplan.csv} % Path to your file
\lstinputlisting{output/output8_finalplan.csv} % Path to your file
\lstinputlisting{output/output9_finalplan.csv} % Path to your file
\lstinputlisting{output/output10_finalplan.csv} % Path to your file
